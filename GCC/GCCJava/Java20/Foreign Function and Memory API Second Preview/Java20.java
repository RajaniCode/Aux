...
// % java --enable-preview --source 19 --enable-native-access=ALL-UNNAMED --add-modules=jdk.incubator.concurrent,jdk.incubator.vector Java20.java
// Or
// % javac -Xlint:preview --enable-preview --source 19 --add-modules=jdk.incubator.concurrent,jdk.incubator.vector Java20.java
// % java --enable-preview --enable-native-access=ALL-UNNAMED --add-modules=jdk.incubator.concurrent,jdk.incubator.vector Java20
// % rm -rf *.class
...
class ForeignFunctionMemoryAPISecondPreview {
    ...
    private void strlenJava19Preview20(String text) {
    ...
    private void qsort(int... unsortedArray) {
	    ...
	    // invoke // unreported exception Throwable; must be caught or declared to be thrown
	    try {   
            	qsortHandle.invoke(array, (long)unsortedArray.length, ValueLayout.JAVA_INT.byteSize(), compareFunc);
	    } catch (Throwable e) {
	    	// e.printStackTrace();
	    	System.out.println(e.getMessage());
	    }
...
// java --enable-preview --source 20 --enable-native-access=ALL-UNNAMED --add-modules=jdk.incubator.concurrent,jdk.incubator.vector Java20.java
/*
Note: Java20.java uses preview features of Java SE 20.
