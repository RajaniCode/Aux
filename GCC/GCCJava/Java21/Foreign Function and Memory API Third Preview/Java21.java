...
// % java --enable-preview --enable-native-access=ALL-UNNAMED Java21
// % rm -rf *.class

// Java 20
// OpenJDK 20
// % export PATH="$HOME/Downloads/Software/OpenJDK/JDK20.0.2/jdk-20.0.2.jdk/Contents/Home/bin/":$PATH
// % java --enable-preview --source 20 --enable-native-access=ALL-UNNAMED --add-modules=jdk.incubator.concurrent,jdk.incubator.vector Java21.java
// Or
// % javac -Xlint:preview --enable-preview --source 20 --add-modules=jdk.incubator.concurrent,jdk.incubator.vector Java21.java
// % java --enable-preview --enable-native-access=ALL-UNNAMED --add-modules=jdk.incubator.concurrent,jdk.incubator.vector Java21
// % rm -rf *.class
...
class Java21 {
	...
	// # 442: Foreign Function & Memory API (Third Preview)
	var thirdPreviewForeignFunctionMemoryAPI = new ForeignFunctionMemoryAPIThirdPreview();
        thirdPreviewForeignFunctionMemoryAPI.print();
    }
}
...
Note: Java21.java uses preview features of Java SE 21.
