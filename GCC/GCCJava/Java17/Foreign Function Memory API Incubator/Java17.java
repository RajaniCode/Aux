...
// % export PATH="$HOME/Downloads/Software/OpenJDK/MicrosoftBuildofOpenJDK/jdk-17.0.8.1+1/Contents/Home/bin/":$PATH
...
class Java17 {
	...
	// # 412: Foreign Function & Memory API (Incubator)
	var incubatorForeignFunctionMemoryAPI = new ForeignFunctionMemoryAPIIncubator();
        incubatorForeignFunctionMemoryAPI.print();
    }
}
